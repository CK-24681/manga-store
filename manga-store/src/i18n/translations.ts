...
export const TRANSLATIONS: Record<Language, TranslationDictionary> = {
  pt: {
    ...
    heroSlide1Title: 'Prime Manga Days • Até 40% OFF nos Mais Vendidos',
    heroSlide1Sub: 'Gear 5 de Luffy, Jujutsu Kaisen e Berserk Deluxe em estoque com Entrega Expressa Prime Grátis.',
    ...
    heroBadgeReturns: '✓prime Devolução Grátis em até 30 Dias',
    ...
    bestSellersSubtitle: 'Nossos produtos mais populares baseados em vendas. Atualizado a cada hora com envio Prime verificado.',
    bestSellersLeaderboard: 'Ranking de Mais Vendidos Mangazon',
    primeClubTitle: 'Clube de Benefícios MangaPrime',
    primeClubSub: 'Entrega rápida no dia seguinte e frete grátis garantido em todo o catálogo',
    primeClubBadge: 'BENEFÍCIO PRIME',
    ...
    freeShippingNeeded: 'Adicione mais {amount} em itens para ganhar FRETE GRÁTIS Prime',
    ...
    oneClickPayment: 'MangaPrime 1-Clique (Finalização Instantânea)',
    ...
    col3Title: 'MangaPrime & Pagamentos',
    col3L1: 'Cartão MangaPrime Visa',
  ...
  en: {
    ...
    heroSlide1Title: 'Prime Manga Days • Up to 40% Off Best Sellers',
    heroSlide1Sub: 'Gear 5 Luffy, Gojo vs Sukuna, and Berserk Deluxe in stock with Free Next-Day Prime Delivery.',
    ...
    heroBadgeReturns: '✓prime 30-Day Free Returns',
    ...
    bestSellersSubtitle: 'Our most popular products based on sales. Updated hourly with Prime verified volumes.',
    bestSellersLeaderboard: 'Mangazon Bestsellers Leaderboard',
    primeClubTitle: 'MangaPrime Benefits Club',
    primeClubSub: 'Fast next-day delivery and free shipping guaranteed across the full catalog',
    primeClubBadge: 'PRIME BENEFIT',
    ...
    freeShippingNeeded: 'Add {amount} of eligible items for FREE Prime Delivery',
    ...
    oneClickPayment: 'MangaPrime 1-Click Instant Checkout',
    ...
    col3Title: 'MangaPrime & Payments',
    col3L1: 'MangaPrime Rewards Visa Card',
  ...
  es: {
    ...
    heroSlide1Title: 'Prime Manga Days • Hasta 40% de Descuento',
    heroSlide1Sub: 'Luffy Gear 5, Jujutsu Kaisen y Berserk Deluxe en stock con Envío Prime Rápido y Gratis.',
    ...
    heroBadgeReturns: '✓prime Devoluciones Gratis 30 Días',
    ...
    freeShippingNeeded: 'Añade {amount} en productos para Envío Prime GRATIS',
    ...
    oneClickPayment: 'MangaPrime 1-Clic (Compra Inmediata)',
    ...
    col3Title: 'MangaPrime y Pagos',
    col3L1: 'Tarjeta MangaPrime Visa',
  ...
  ja: {
    ...
    heroSlide1Title: 'プライム・マンガデイ • ベストセラー最大40%OFF',
    heroSlide1Sub: 'ルフィGear 5、呪術廻戦、ベルセルク愛蔵版がプライム翌日無料配送でお手元に。',
    ...
    heroBadgeReturns: '✓prime 30日間無料返品可能',
    ...
    bestSellersSubtitle: '売上に基づく人気タイトルランキング。1時間ごとに更新・プライム翌日配送対応。',
    bestSellersLeaderboard: 'Mangazon 売上ランキング',
    primeClubTitle: 'MangaPrime 特典クラブ',
    primeClubSub: '全商品プライム無料配送と限定クーポン特典',
    primeClubBadge: 'プライム会員特典',
    ...
    oneClickPayment: 'MangaPrime 1-Click (即時決済)',
    ...
    col3Title: 'お支払い・MangaPrime',
    col3L1: 'MangaPrime リワードカード',
    col3L2: 'オタクポイントでお買い物',
    col3L3: 'ギフト券残高チャージ',
    col3L4: '通貨換算ツール',
